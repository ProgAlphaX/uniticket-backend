...
public class Usuario {
    ...
    public Long getNId_Usuario() { return nId_Usuario; }

    public void setNId_Usuario(Long nId_Usuario) { this.nId_Usuario = nId_Usuario; }

    public String getSNombreCompleto() { return sNombreCompleto; }

    public void setSNombreCompleto(String sNombreCompleto) { this.sNombreCompleto = sNombreCompleto; }
    ...
    public String getSPasswordHash() { return sPasswordHash; }

    public void setSPasswordHash(String sPasswordHash) { this.sPasswordHash = sPasswordHash; }

    public String getSRol() { return sRol; }

    public void setSRol(String sRol) { this.sRol = sRol; }

    public String getSEstado() { return sEstado; }

    public void setSEstado(String sEstado) { this.sEstado = sEstado; }

    public LocalDateTime getDFecha_Creacion() { return dFecha_Creacion; }

    public void setDFecha_Creacion(LocalDateTime dFecha_Creacion) { this.dFecha_Creacion = dFecha_Creacion; }
}
